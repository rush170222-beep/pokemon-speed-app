...
// メガニャオニクス画像修正：メガ画像が存在しない場合も通常ニャオニクス画像へフォールバック
...
function enemySetting(){const t=$("enemyType").value;if(t==="fast")return{nature:1.1,pt:32};if(t==="semi")return{nature:1,pt:32};if(t==="none")return{nature:1,pt:0};return{nature:.9,pt:0};}
...
fillRank();fillPokemonSelect();
["mySearch","myPokemon","baseSpeed","abilityPt","nature","rank","other","enemyType","enemyOther","listSearch"].forEach(id=>$(id).addEventListener("input",()=>{if(id==="mySearch")fillPokemonSelect();else if(id==="myPokemon")updateSelectedPokemon();else render();}));
